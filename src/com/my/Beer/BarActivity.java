...
public class BarActivity extends ListActivity {
	...
	public void onCreate(Bundle bundle) {
		...
		/* si on appuie sur un item de la liste, on ouvre sa fiche */
		this.getListView().setOnItemClickListener(
				new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Intent i = new Intent(BarActivity.this
								.getApplicationContext(), BeerActivity.class);
	...
	protected void onStart() {
		...
		if (donnees.getLong("id") != -1) {
			 ...
			 */
			if (tab[0] != "")
				setListAdapter(new BarArrayAdapter(noms, prix, type, img, ids,
						this));
		}
		// sinon on peut ajouter un bière
		else {
