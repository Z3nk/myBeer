...
public class Beer_DAO {
	...
	public Beer getBeer(String tab) {
		Cursor curseur = bd.query("beer", null, "idServer = '" + tab + "'",
				null, null, null, null);
	...
	public int updateFromIdServer(Beer b) {
		...
		valeurs.put("idUpdate", b.getIdUpdate());
		valeurs.put("idServer", b.getIdServer());
		return bd.update("beer", valeurs, "idServer = ? ",
				new String[] { b.getIdServer() });// AND idUpdate != ? ,
													// Integer.toString(bar.getIdUpdate())
	}
